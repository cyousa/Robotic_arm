...
void sccb_send_byte(uint16_t reg,uint8_t data)
{
 ...
 void ov5640_get_output_size(void)
{
   ...
   HAL_Delay(100);
    ...
    reg3808 = OV5640_RD_Reg(0x3808);
    reg3809 = OV5640_RD_Reg(0x3809);
    reg380A = OV5640_RD_Reg(0x380A);
    reg380B = OV5640_RD_Reg(0x380B);
